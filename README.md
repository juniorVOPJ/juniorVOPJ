...
- 🔭 Desenvolvo aplicações de automação (RPA), ferramentas de segurança da informação e forense computacional
- 🌱 Tenho meus próprios modelos generativos treinados com as mais diferentes tecnologias do mercado
- 🛠️ Criador do ASFIXIA (análise de vínculos com cadeia de custódia), FY-CMS, RADSTATION e SUINDARA
- 📫 Se alguém tiver interesse, pode entrar em contato comigo pelos links sociais ou no Zello: junior.vopj

## Sobre mim 🧑‍💻

Engenheiro de Software registrado no CREA-GO e Tecnólogo em Defesa Cibernética pela Universidade Estácio de Sá. Mestrando em Cyber Security pela American Global Tech University (EUA). Pós-graduado em Segurança da Informação, Segurança Pública e Docência em Armamento e Tiro. Certified Ethical Hacker (CEH) e Certified Network Defense Architect (CNDA) pela EC-Council (2020–2023), finalista do CEH Hall of Fame 2021. Diretor-Geral da Agência Federal de Segurança, Tecnologia e Fiscalização, com atuação em forense computacional, análise de incidentes cibernéticos e proteção de dados (LGPD). Autor de análises técnicas publicadas e compositor com obras registradas na BMI.
